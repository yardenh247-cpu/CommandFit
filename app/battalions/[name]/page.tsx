...
const COMPANY_COUNTS: Record<string, number> = {
  "דקל": 4, "רימון": 4, "גפן": 4, "דולב": 2, "חרוב": 4,
  "הדס": 5, "ארז": 5, "ברוש": 5, "אלון": 5,
};
const COMPANY_NAMES = ["פלוגה א׳","פלוגה ב׳","פלוגה ג׳","פלוגה ד׳","פלוגה ה׳"];
function getCompanies(battalion: string) {
  return COMPANY_NAMES.slice(0, COMPANY_COUNTS[battalion] ?? 5);
}
function companyScopeLabel(companies: string[]) {
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                      ...
                      {!readOnly && (
                        <div className="flex flex-col sm:flex-row gap-2">
                          ...
                          <div className="flex flex-wrap items-center gap-2 border border-slate-200 bg-slate-50 rounded-xl p-2">
                            <button
                              type="button"
                              onClick={() =>
                              ...
                              className={(selectedCompanies[weekNumber] ?? []).length === 0
                                ? "bg-slate-900 text-white rounded-lg px-3 py-2 text-sm font-bold"
                                : "bg-white border border-slate-200 text-slate-700 rounded-lg px-3 py-2 text-sm font-bold"}
                            >
                              כלל הגדוד
                            </button>
                            ...
                            {companies.map((company) => {
                              const selected =
                                (selectedCompanies[weekNumber] ?? []).includes(company);
                                  ...
                                  onClick={() =>
                                    setSelectedCompanies((current) => {
                                      ...
                                      return {
                                        ...current,
                                        [weekNumber]: selected
                                          ? existing.filter((item) => item !== company)
                                          : [...existing, company],
                                      };
                                    })
                                  }
                                  className={selected
                                    ? "bg-blue-700 text-white rounded-lg px-3 py-2 text-sm font-bold"
                                    : "bg-white border border-blue-200 text-blue-800 rounded-lg px-3 py-2 text-sm font-bold hover:bg-blue-50"}
                                >
                                  {company}
                                </button>
                              );
                            ...
                            >
                              ...
                              <div>
                                ...
                                <p className="text-sm font-bold text-blue-700 mt-1">
                                  {companyScopeLabel(session.companies)}
                                </p>
